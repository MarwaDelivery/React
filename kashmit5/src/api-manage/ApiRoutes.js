...
export const categories_list_api = "/api/v1/special-category/list";
export const categories_list_api_one = "/api/v1/special-category-one/list";
export const special_store_details = "/api/v1/special-store";
export const update_interest_api = "/api/v1/customer/update-interest";
export const ai_bot_message_list = "api/v1/customer/agent-chat/details";
